...
public:
  ...
  void test_accessor_methods() {
    ...
    std::string encodedA = make_encoded("5:id789|1:2|6:key123|");
    Accessor::decode_entity(&r1, encodedA.c_str());
    EQUAL(arcs::entity_to_str(r1), "REF<id789|2|key123>");
    ...
    std::string encodedB = make_encoded("4:idAA|1:2|6:key789|");
    ...
    Accessor::decode_entity(&r2, make_encoded("5:idXXX|1:2|6:key789|").c_str());
    NOT_EQUAL(arcs::hash_entity(r1), arcs::hash_entity(r2));

    // Same ids, different storage keys.
    Accessor::decode_entity(&r2, make_encoded("4:idAA|1:2|5:key00|").c_str());
    NOT_EQUAL(arcs::hash_entity(r1), arcs::hash_entity(r2));
  }
  ...
  void test_empty_references() {
    ...
    EQUAL(Accessor::encode_entity(r), make_encoded("0:|0:|0:|").c_str());
  ...
  void test_populated_references() {
    ...
    Accessor::decode_entity(&r, make_encoded("5:id789|1:4|6:key123|").c_str());
    IS_FALSE(r.is_dereferenced());
    EQUAL(r.entity(), arcs::ReferenceClassApiTest_Data());
    ...
    EQUAL(arcs::entity_to_str(r), "REF<id789|4|key123|[{id789}, num: 42, txt: ltuae]>");
    ...
    EQUAL(Accessor::encode_entity(r), make_encoded("5:id789|1:4|6:key123|").c_str());
  ...
  void test_shared_references() {
    arcs::Ref<arcs::ReferenceClassApiTest_Data> r1;
    Accessor::decode_entity(&r1, make_encoded("5:id789|1:3|6:key123|").c_str());
    ...
    EQUAL(arcs::entity_to_str(r1), "REF<id789|3|key123>");
    EQUAL(arcs::entity_to_str(r2), "REF<id789|3|key123>");
    ...
    EQUAL(arcs::entity_to_str(r1), "REF<id789|3|key123|[{id789}, num: 4, txt: four]>");
    EQUAL(arcs::entity_to_str(r2), "REF<id789|3|key123|[{id789}, num: 4, txt: four]>");
  ...
  void test_operators() {
    ...
    // different ids
    Accessor::decode_entity(&r1, make_encoded("3:idA|1:6|4:keyA|").c_str());
    Accessor::decode_entity(&r2, make_encoded("4:idXX|1:6|4:keyA|").c_str());
    NOT_EQUAL(r1, r2);
    LESS(r1, r2);
    NOT_LESS(r2, r1);

    // different keys
    Accessor::decode_entity(&r2, make_encoded("3:idA|1:6|5:keyXX|").c_str());
    NOT_EQUAL(r1, r2);
    LESS(r1, r2);
    NOT_LESS(r2, r1);

    // same ids and keys
    Accessor::decode_entity(&r2, make_encoded("3:idA|1:6|4:keyA|").c_str());
    EQUAL(r1, r2);
    NOT_LESS(r1, r2);
    NOT_LESS(r2, r1);
  ...
  void test_stl_vector() {
    ...
    data_.set_txt("abc");
    arcs::Ref<arcs::ReferenceClassApiTest_Data> r2;
    Accessor::decode_entity(&r2, make_encoded("3:idA|1:7|4:keyA|").c_str());
    dereference(r2, [] {});

    // populated but not dereferenced
    arcs::Ref<arcs::ReferenceClassApiTest_Data> r3;
    Accessor::decode_entity(&r3, make_encoded("3:idB|1:8|4:keyB|").c_str());

    // same reference as r2, but not a copy
    arcs::Ref<arcs::ReferenceClassApiTest_Data> r4;
    Accessor::decode_entity(&r4, make_encoded("3:idA|1:9|4:keyA|").c_str());
    ...
    std::vector<std::string> expected = {
      "REF<>",
      "REF<idA|7|keyA|[{idA}, num: 99, txt: abc]>",
      "REF<idB|8|keyB>",
      "REF<idA|9|keyA>"
    };
  ...
  void test_stl_set() {
    ...
    data_.set_txt("zz");
    arcs::Ref<arcs::ReferenceClassApiTest_Data> r2;
    Accessor::decode_entity(&r2, make_encoded("3:idA|1:2|4:keyA|").c_str());
    dereference(r2, [] {});

    // populated but not dereferenced
    arcs::Ref<arcs::ReferenceClassApiTest_Data> r3;
    Accessor::decode_entity(&r3, make_encoded("3:idB|1:2|4:keyB|").c_str());

    // same reference as r2, but not a copy
    arcs::Ref<arcs::ReferenceClassApiTest_Data> r4;
    Accessor::decode_entity(&r4, make_encoded("3:idA|1:2|4:keyA|").c_str());
    ...
    std::vector<std::string> expected = {
      "REF<>",
      "REF<idA|2|keyA|[{idA}, num: 47, txt: zz]>",
      "REF<idB|2|keyB>"
    };
  ...
  void test_stl_unordered_set() {
    ...
    std::vector<std::string> expected = {
      "REF<>",
      "REF<idA|2|keyA|[{idA}, num: 585, txt: xtx]>",
      "REF<idB|2|keyB>"
    };
    CHECK_UNORDERED(s, converter(), expected);
  }
